...
# License AGPL-3.0 or later (http://www.gnu.org/licenses/agpl).
{
    ...
    "depends": [
        "base_setup", "base_territory", "base_geolocalize", "resource",
        "contacts", "l10n_th_location_base", "base", "mail", "stock",
    ],
    "data": [
        ...
        "data/fsm_stage.xml",
        "data/fsm_team.xml",
        "data/fsm_pm_cron.xml",
        "data/fsm_service_type.xml",
        "data/fsm_equipment_condition.xml",
        "data/fsm_pm_frequency.xml",
        ...
        "views/fsm_order.xml",
        "views/fsm_phe_unit.xml",
        "views/fsm_pm_schedule.xml",
        "views/fsm_service_type.xml",
        "views/fsm_equipment_condition.xml",
        "views/fsm_pm_frequency.xml",
